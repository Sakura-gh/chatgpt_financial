...
def parse_docx(file_manifest, project_folder, top_p, temperature, chatbot, history, systemPromptTxt):
    import time, os
...
@CatchException
def summary_doc(txt, top_p, temperature, chatbot, history, systemPromptTxt, WEB_PORT):
    import glob, os
    ...
    # 开始正式执行任务
    yield from parse_docx(file_manifest, project_folder, top_p, temperature, chatbot, history, systemPromptTxt)
