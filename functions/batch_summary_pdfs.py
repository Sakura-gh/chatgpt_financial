...
def parse_PDF(file_manifest, project_folder, top_p, temperature, chatbot, history, systemPromptTxt):
...
def batch_summary_pdfs(txt, top_p, temperature, chatbot, history, systemPromptTxt, WEB_PORT):
    ...
    # 开始正式执行任务
    yield from parse_PDF(file_manifest, project_folder, top_p, temperature, chatbot, history, systemPromptTxt)
